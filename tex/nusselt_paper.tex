...
Select cases have been run in three dimensions with $y$ in the range
$[0, 4L_z]$.
...
Ra to 1024x4096 coefficient points at Ra$_{\text{top}} > 10^{7}$ in 2D,
and 64x128$^2$ to  128x256$^2$ in 3D. 
