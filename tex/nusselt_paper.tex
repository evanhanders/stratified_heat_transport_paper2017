...
incompressible Rayleigh-B\'{e}nard problem.
...
we fix $\epsilon$ and vary Ra, thus increasing the diffusive
timescales, and a second in which we fix Ra and vary $\epsilon$,
thus...
