...
When Ma $< 1$, we observe a scaling law of
...
no-slip boundary conditions that disallow time-dependent shear states.
...
At low Ra, Re $\propto$ Ra$^{3/4}$.  At high Ra and $\epsilon$, 
...
these points difficult to measure.
