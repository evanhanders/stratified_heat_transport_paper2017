...
incompressible Rayleigh-B\'{e}nard problem in both 2D and 3D.
...
These prior studies \cite{hurlburt&all1984, cattaneo&all1990, brummell&all1996,
...
properties of low Ma compressible convection, such as the nature of
...
We find that the scaling of Nu is similar to the scaling of Nu in \RB convection,
...
We nondimensionalize our domains by setting
...
controlled by the superadiabaticity
...
We leave $\kappa = \rho\chi$ and 
$\mu = \rho\nu$ (the dynamic viscosity) free to evolve as the density 
profile evolves.  

Atmospheric diffusivities thus scale as
\begin{equation}
...
thus decreasing the ratio of the buoyant timescale to the 
...
convection.  These states are represented in Figs. 
\ref{fig:ma_v_eps}, \ref{fig:re_and_nu_v_ra}, \& \ref{fig:nrho_v_ra}
as hatched points, and while they do not appear to greatly modify the
scalings of fluid properties measured in this work, these states warrant
further investigation, and similar states have been seen in
RB convection \cite{goluskin&all2014}.
...
As Ra is increased to large values (Fig. \ref{fig:entropy_snapshots}c) 
and diffusivities become small according to (\ref{eqn:diffusivities}),
...
seen in Fig. \ref{ma_v_ra}.  When the flows
become supersonic, 
